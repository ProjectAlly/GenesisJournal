...
<body>
	<div class="container_16" id="main">
		...
		<div class="grid_16" id="display">
			<ul id="subNavigation">
				<li><a class="current">Submit Article</a></li>
			</ul>
		</div>
		<!-- /SUBMENU -->
		<div class="clear"></div>
	...
	<div class="container_16" id="content">
		...
		<div class="grid_11 content" id="two_col">
			...
			<p>
			Manuscript along with cover letter can be submitted by mail on <a href="mailto:pharmagenejournal@gmail.com" target="_blank">
			pharmagenejournal@gmail.com</a>
			</p>
			<p><b>P.S.</b>
			There is no need to send a hardcopy.
			</p>
